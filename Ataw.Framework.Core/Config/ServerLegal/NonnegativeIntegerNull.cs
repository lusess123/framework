...
{
    [CodePlug("nonnegativeIntegerNull", BaseClass = typeof(IServerLegal),
     CreateDate = "2013-08-12", Author = "zgl", Description = "服务端验证非负整数插件（可以为空）")]
    public class NonnegativeIntegerNull : IServerLegal
    {
