...
{
    [CodePlug("VehicleLimitLegalNull", BaseClass = typeof(IServerLegal),
        CreateDate = "2013-08-12", Author = "zgl", Description = "服务端验证(车辆油耗、初始公里数、承重、商品价格)集合插件（可以为空）")]
    class VehicleLimitLegalNull : IServerLegal
    {
