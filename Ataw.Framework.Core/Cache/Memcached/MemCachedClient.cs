...
namespace Ataw.Framework.Core.Cache
{
    ...
    public class MemcachedClient
    {
        ...
        // logger
        private static ILogs log = AtawAppContext.Current.Logger;
        ...
        private static ResourceManager _resourceManager = new ResourceManager("Ataw.Framework.Core.Cache.Memcached.StringMessages", typeof(MemcachedClient).Assembly);
