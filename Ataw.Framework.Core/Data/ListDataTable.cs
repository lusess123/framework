    ...
    public abstract class ListDataTable : IListDataTable ,IDisposable
    {
        ...
        public virtual void AppendTo(DataSet ds)
        {
            ...
            if (list != null && list.Count > 0)
            {
                ...
                DataTable table = DataSetUtil.ToDataTable(list, _type);
        ...
        public JsResponseResult<int> Result
        {
            get;
            set;
        }
        ...
        public virtual NumModel GetNumModel()
        {
            return null;
        }
        ...
        {
            if (this.fSubmitFilterFun != null)
            {
                this.fSubmitFilterFun = null;
            }
        }
    }
}
