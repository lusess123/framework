...
using Ataw.Framework.Core.Config;
...
{
    public class EditorFileManagerController : AtawBaseController
    {
        private readonly string ThumbsPath = GlobalVariable.Context.Server.MapPath("/Images/Thumbs/");
